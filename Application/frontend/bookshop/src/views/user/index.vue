  ...
  <div>
    ...
    <el-row>
      ...
      <el-col :span="24">
        ...
        >
          ...
          <el-table-column prop="loginName" label="User Name"></el-table-column>
    ...
    >
      ...
      <el-form :model="userForm" label-width="70px">
        <el-form-item label="Account" prop="loginName">
      ...
      if (confirmResult == "confirm") {
        ...
        userBatchDelete(this.ids)
          .then((res) => {
            if (res.data.code === 200) {
              this.$message({
                message: "Delete mutiple users",
                type: "success",
              });
              this.getUserList();
            } else {
              this.$message.error("Delete mutiple users success");
            }
          })
          .catch((err) => {
            this.$message.error("Delete mutiple users failed");
            console.log(err);
          });
      }
    }
